console.log("Before game init check");
var gameWindow = null;

function startGame() {
  if (!gameWindow || gameWindow.closed) {
    gameWindow = window.open('game.html', 'FlappyBirdGame', 'width=800,height=600');
  } else {
    gameWindow.focus();
  }
}
...
console.log("URL:", url);
console.log("Error code:", ec);
console.log("Error description:", errDesc);
console.log("Game canvas:", document.getElementById('gameCanvas'));
